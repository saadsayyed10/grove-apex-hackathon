...
export default function Waiting() {
  ...
  return (
    <div className="min-h-screen bg-[#f4f6fb] flex flex-col items-center justify-center px-4 font-sans antialiased">
      ...
      {/* Logo */}
      <div className="mb-8 flex items-center gap-1 lg:mt-4 font-bold text-xl tracking-tight text-gray-900 z-10">
        Grove<span className="text-blue-600">Apex</span>
      </div>

      {/* Card */}
      <Card className="z-10 w-full max-w-md shadow-xl border border-gray-200 bg-white rounded-2xl overflow-hidden">
        {/* Top accent strip */}
        <div className="h-1.5 w-full bg-linear-to-r from-blue-500 via-blue-400 to-indigo-500" />
      ...
      {/* Footer note */}
      <p className="mt-6 mb-4 text-xs text-gray-400 z-10 text-center">
        Need help?{" "}
        <a
          href="mailto:support@goveval.ai"
